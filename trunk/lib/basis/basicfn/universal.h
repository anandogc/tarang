...
//	virtual TinyVector<DP,3> Get_local_spectral_field(int lx, int ly, int lz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az) = 0;
    ...
    virtual int Read(Array<complx,3> A, BasicIO::H5_plan plan, string file_name, string dataset_name="") = 0;
    virtual int Read(Array<DP,3> Ar, BasicIO::H5_plan plan, string file_name, string dataset_name="") = 0;

    virtual int Write(Array<complx,3> A, BasicIO::H5_plan plan, string folder_name, string file_name, string dataset_name="") = 0;
    virtual int Write(Array<DP,3> Ar, BasicIO::H5_plan plan, string folder_name, string file_name, string dataset_name="") = 0;
};
