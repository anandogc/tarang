...
class SFF_slab_Isend_Recv_3D : public SpectralPlan_Slab_3D {
private:
	...
	DP f(string sincostr_option, int rx, int ry, int rz);
	void Init_array();
...
public:
	...
	SFF_slab_Isend_Recv_3D(int my_id, int numprocs, int num_iter, int N0, int N1, int N2);
