...
//*********************************************************************************************
SFF_slab_Alltoall_3D::SFF_slab_Alltoall_3D(int my_id, int numprocs, int num_iter, int Nx, int Ny, int Nz): SpectralPlan_Slab_3D("SFF", my_id, numprocs, Nx, Ny, Nz)
{
...
DP SFF_slab_Alltoall_3D::f(string sincostr_option, int rx, int ry, int rz)
{
	DP k0 = 1;
	DP x,y,z;
...
void SFF_slab_Alltoall_3D::Init_array()
{
	Xr_3d=0;
