...
class SSF_slab_Alltoall_3D : public SpectralPlan_Slab_3D {
private:
	...
	void FT_r2c_z(Array<complx,3> A);
	void IFT_c2r_z(Array<complx,3> A);

public:

	SSF_slab_Alltoall_3D(int my_id, int numprocs, int num_iter, int Nx, int Ny, int Nz);
