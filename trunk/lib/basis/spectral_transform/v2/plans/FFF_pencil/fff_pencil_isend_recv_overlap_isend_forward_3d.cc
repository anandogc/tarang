...
//*********************************************************************************************
FFF_slab_Isend_Recv_overlap_Isend_forward_3D::FFF_slab_Isend_Recv_overlap_Isend_forward_3D(int my_id, int numprocs, int num_iter, int Nx, int Ny, int Nz): SpectralPlan_Slab_3D(my_id, numprocs, Nz, Ny, Nz)
{
