...
class FFF_slab_Alltoall_3D : public SpectralPlan_Slab_3D {
private:
	...
	void FT_r2c_yz(Array<DP,3> A);
	void IFT_c2r_yz(Array<DP,3> A);
...
public:
	...
	FFF_slab_Alltoall_3D(int my_id, int numprocs, int num_iter, int Nx, int Ny, int Nz);
