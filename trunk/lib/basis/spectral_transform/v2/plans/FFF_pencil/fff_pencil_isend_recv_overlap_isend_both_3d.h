...
class FFF_slab_Isend_Recv_overlap_Isend_both_3D : public SpectralPlan_Slab_3D
{
private:
...
public:
	...
	FFF_slab_Isend_Recv_overlap_Isend_both_3D(int my_id, int numprocs, int num_iter, int Nx, int Ny, int Nz);
