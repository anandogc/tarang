...
class FFF_slab_Isend_Recv_overlap_Isend_forward_3D : public SpectralPlan {
private:
...
public:
	...
	FFF_slab_Isend_Recv_overlap_Isend_forward_3D(int my_id, int numprocs, int Nx, int Ny, int Nz);
