...
class FFF_slab_Alltoall_2D : public SpectralPlan_Slab_2D {
private:
	...
	void FT_r2c_z(Array<DP,2> A);
	void IFT_c2r_z(Array<DP,2> A);
...
public:
	...
	FFF_slab_Alltoall_2D(int my_id, int numprocs, int num_iter, int Nx, int Nz);
