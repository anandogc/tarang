...
//*********************************************************************************************
FFF_slab_Isend_Recv_overlap_Isend_forward_3D::FFF_slab_Isend_Recv_overlap_Isend_forward_3D(int my_id, int numprocs, int Nx, int Ny, int Nz): SpectralPlan(my_id, numprocs, Nz, Ny, Nz)
{
