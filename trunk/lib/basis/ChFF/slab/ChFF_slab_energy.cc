...
Real ChFF_SLAB::Get_local_energy_real_space(Array<Real,3> Ar)
{
    int rx;
    Real factor,x;
    Real sum = 0.0;
...
Real ChFF_SLAB::Get_local_energy(Array<Complex,3> A)  
{
...
Real ChFF_SLAB::Get_local_energy_real_space(Array<Real,3> Ar, Array<Real,3> Br)
{
    int rx;
    Real factor,x;
    Real sum = 0.0;
...
Real ChFF_SLAB::Get_local_energy(Array<Complex,3> A, Array<Complex,3> B)
{
