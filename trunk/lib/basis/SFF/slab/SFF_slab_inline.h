...
inline Complex SFF_SLAB::Get_spectral_field(int kx, int ky, int kz, Array<Complex,3> A)
{ 
	int lx = Get_lx(kx);
    int ly = Get_ly(ky);
...
inline TinyVector<Complex,3> SFF_SLAB::Get_spectral_field(int kx, int ky, int kz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az)
{
...
/*
inline void SFF_SLAB::Get_spectral_field(int kx, int ky, int kz, Array<Complex,3> A,Real &field)
{ 
	cout << "MYERROR: SFF_SLAB::Get_spectral_field(); Use complex data type " << endl; 
}

inline void SFF_SLAB::Get_spectral_field(int kx, int ky, int kz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, TinyVector<Real,3> &V)
{
...
inline void SFF_SLAB::Assign_spectral_field(int kx, int ky, int kz, Array<Complex,3> A, Complex field)
{ 
	int lx = Get_lx(kx);
    int ly = Get_ly(ky);
...
inline void SFF_SLAB::Assign_spectral_field(int kx, int ky, int kz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, TinyVector<Complex,3> V)
{
...
inline void SFF_SLAB::Assign_spectral_field(int kx, int ky, int kz, Array<Complex,3> A,Real field)
{ 
	cout << "MYERROR: SFF_SLAB:Assign_spectral_field(); Use complex data type " << endl; 
}

inline void SFF_SLAB::Assign_spectral_field(int kx, int ky, int kz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, TinyVector<Real,3> V)
{
	
	cout << "MYERROR: SFF_SLAB::Assign_spectral_field(); Use complex data type " << endl;
}

inline void SFF_SLAB::Add_spectral_field(int kx, int ky, int kz, Array<Complex,3> A, Complex field)
{ 
	int lx = Get_lx(kx);
    int ly = Get_ly(ky);
...
inline void SFF_SLAB::Add_spectral_field(int kx, int ky, int kz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, TinyVector<Complex,3> V)
{
...
inline void SFF_SLAB::Add_spectral_field(int kx, int ky, int kz, Array<Complex,3> A,Real field)
{ 
	cout << "MYERROR: SFF_SLAB:Assign_spectral_field(); Use complex data type " << endl; 
}

inline void SFF_SLAB::Add_spectral_field(int kx, int ky, int kz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, TinyVector<Real,3> V)
{
...
inline Complex SFF_SLAB::Get_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> A)
{ 
	 return A(lx, ly, lz);
}

inline TinyVector<Complex,3> SFF_SLAB::Get_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az)
{
...
/*
inline void SFF_SLAB::Get_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> A,Real &field)
{ 
	cout << "MYERROR: SFF_SLAB::Get_local_spectral_field(); Use complex data type " << endl; 
}

inline void SFF_SLAB::Get_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, TinyVector<Real,3> &V)
{
	
	cout << "MYERROR: SFF_SLAB::Get_local_spectral_field(); Use complex data type " << endl;
}*/

inline void SFF_SLAB::Assign_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> A, Complex field)
{ 
...
inline void SFF_SLAB::Assign_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, TinyVector<Complex,3> V)
{
	if ((lx >= 0) && (lx < local_Nx)) {
		Ax(lx, ly, lz) = V(0);
		Ay(lx, ly, lz) = V(1);
...
inline void SFF_SLAB::Assign_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> A,Real field)
{ 
	cout << "MYERROR: SFF_SLAB:Assign_local_spectral_field(); Use complex data type " << endl; 
}

inline void SFF_SLAB::Assign_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, TinyVector<Real,3> V)
{
...
inline void SFF_SLAB::Add_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> A, Complex field)
{ 
...
inline void SFF_SLAB::Add_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, TinyVector<Complex,3> V)
{
	if ((lx >= 0) && (lx < local_Nx)) {
		Ax(lx, ly, lz) += V(0);
		Ay(lx, ly, lz) += V(1);
...
inline void SFF_SLAB::Add_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> A,Real field)
{ 
	cout << "MYERROR: SFF_SLAB:Assign_local_spectral_field(); Use complex data type " << endl; 
}

inline void SFF_SLAB::Add_local_spectral_field(int lx, int ly, int lz, Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, TinyVector<Real,3> V)
{
...
inline Real SFF_SLAB::Get_real_field(int rx, int ry, int rz, Array<Real,3> A)
{
...
inline TinyVector<Real,3> SFF_SLAB::Get_real_field(int rx, int ry, int rz, Array<Real,3> Ax, Array<Real,3> Ay, Array<Real,3> Az)
{
    if (Probe_in_me_real_space(rx,ry,rz)) {
		int ly = Get_ly_real_space(ry);
		int lz = Get_lz_real_space(rz);
...
inline void SFF_SLAB::Assign_real_field(int rx, int ry, int rz, Array<Real,3> A, Real field)
{	
    if (Probe_in_me_real_space(rx,ry,rz)) {
		int ly = Get_ly_real_space(ry);
		int lz = Get_lz_real_space(rz);
...
inline void SFF_SLAB::Assign_real_field(int rx, int ry, int rz, Array<Real,3> Ax, Array<Real,3> Ay, Array<Real,3> Az, TinyVector<Real,3> V)
{
	if (Probe_in_me_real_space(rx,ry,rz)) {
		int ly = Get_ly_real_space(ry);
		int lz = Get_lz_real_space(rz);
...
inline void SFF_SLAB::Wavenumber(int lx, int ly, int lz, TinyVector<Real,3> &K)
{
...
// Omega = cross(V,K).
inline void SFF_SLAB::Wavenumber(int lx, int ly, int lz, TinyVector<Complex,3> &K)
{
...
inline Real SFF_SLAB::Kmagnitude(int lx, int ly, int lz)
{ 
 ...
 */
inline Real SFF_SLAB::Approx_number_modes_in_shell(int radius)
{
    if (global.field.waveno_switch)
 ...
 */
inline Real SFF_SLAB::Multiplicity_factor(int lx, int ly, int lz)
{
	Real factor;
...
/// Modal energy  = \f$ E(k) =  |A(k_x, \vec{k}_{\perp})|^{2} \f$  if  \f$ (k_x > 0) \f$.  <BR>
/// Modal energy  = \f$ E(k) =  |A(0, \vec{k}_{\perp})|^{2}/2 \f$  if  \f$ (k_x = 0) \f$.  <BR>
inline Real SFF_SLAB::Modal_energy(int lx, int ly, int lz, Array<Complex,3> A)
{
...
inline Real SFF_SLAB::Get_Modal_helicity
(
...
inline Real SFF_SLAB::AnisKpll(int lx, int ly, int lz)
{	
...
inline Real SFF_SLAB::AnisKperp(int lx, int ly, int lz)
{
	if (global.field.anisotropy_dirn == 1)
...
inline Real SFF_SLAB::AnisKh1(int lx, int ly, int lz)
{	
	if (global.field.anisotropy_dirn == 1)
		return (Get_ky(ly) * kfactor[2]); 
...
inline Real SFF_SLAB::AnisKh2(int lx, int ly, int lz)
{	
	if (global.field.anisotropy_dirn == 1)
		return (Get_kz(lz) * kfactor[3]);  
...
inline Real SFF_SLAB::Anis_min_Kpll() 
{ 
	return 0.0;
}
				
/// Cylindrical: Anis_max_Kpll
inline Real SFF_SLAB::Anis_max_Kpll() 
{ 
...
// Max polar angle
inline Real SFF_SLAB::Get_max_polar_angle() 
{	
 ...
 */	
inline Real SFF_SLAB::AnisKvect_polar_angle(int lx, int ly, int lz)
{
	Real kkpll, kkperp;
 ...
 * \return \f$ \pi/2 \f$ if \f$ K_{||} = 0 \f$.
 */	
inline Real SFF_SLAB::AnisKvect_azimuthal_angle(int lx, int ly, int lz)
{
