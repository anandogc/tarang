...
Real SFF_SLAB::Get_local_energy_real_space(Array<Real,3> Ar)
{
...
// 2D included in this
Real SFF_SLAB::Get_local_energy(Array<Complex,3> A)  
{
...
/*
// Exclude |A(kx,0,0)|^2
Real SFF_SLAB::Get_total_energy_residual(Array<Complex,3> A)
{
	
	Real local_total = Get_local_energy(A);
...
Real SFF_SLAB::Get_local_energy_real_space(Array<Real,3> Ar, Array<Real,3> Br)
{
...
// 2D included in this
Real SFF_SLAB::Get_local_energy(Array<Complex,3> A, Array<Complex,3> B)
{
 ...
 ***********************************************************************************************/
/*
Real SFF_SLAB::Get_local_Sn_anis(Array<Complex,3> A, Real n)
{
	Real Sn = 0.0;
	Real Kmag, Kperpsqr;
...
Real SFF_SLAB::Get_total_Sn_anis(Array<Complex,3> A, Real n)
{
	
	Real local_total = Get_local_Sn_anis(A, n);
