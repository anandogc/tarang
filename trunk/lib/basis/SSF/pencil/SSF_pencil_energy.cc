...
DP SSF_PENCIL::Get_local_energy_real_space(Array<DP,3> Ar)
{
	DP ans;
...
DP SSF_PENCIL::Get_local_energy(Array<complx,3> A)  
{
...
DP SSF_PENCIL::Get_local_energy_real_space(Array<DP,3> Ar, Array<DP,3> Br)
{
	DP ans;
...
DP SSF_PENCIL::Get_local_energy(Array<complx,3> A, Array<complx,3> B)
{
