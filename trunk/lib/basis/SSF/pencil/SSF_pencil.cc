...
SSF_PENCIL::SSF_PENCIL()
{
	...
	BasicIO::id_complex_array = global.mpi.my_hor_pcoord,0,global.mpi.my_vert_pcoord;
	BasicIO::id_real_array = global.mpi.my_vert_pcoord,global.mpi.my_hor_pcoord,0;
	...
	BasicIO::Fourier_directions = 0,0,1;
