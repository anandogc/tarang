...
{
	if ( Ny>1 ) {
		fftk.Forward_transform_3d(global.program.sincostr_switch, Ar, A);
	}
	else if (Ny == 1) {
		fftk.Forward_transform_2d(global.program.sincostr_switch, Ar(Range::all(),0,Range::all()), A(Range::all(),0,Range::all()));
	}
}
...
void SSF_PENCIL::Inverse_transform(Array<Complex,3> A, Array<Real,3> Ar)
{
	...
	if ( Ny>1 ) {
		fftk.Inverse_transform_3d(global.program.sincostr_switch, global.temp_array.X_transform, Ar);
	}
	else if (Ny == 1) {
		fftk.Inverse_transform_2d(global.program.sincostr_switch, global.temp_array.X_transform(Range::all(),0,Range::all()), Ar(Range::all(),0,Range::all()));
	}
}
...
void  SSF_PENCIL::Xderiv(Array<Complex,3> A, Array<Complex,3> B)
{	
	Real Kx;
...
void  SSF_PENCIL::Add_Xderiv(Array<Complex,3> A, Array<Complex,3> B)
{
	Real Kx;
...
void  SSF_PENCIL::Xderiv(Array<Real,3> A, Array<Real,3> B)
{
...
void SSF_PENCIL::Yderiv(Array<Complex,3> A, Array<Complex,3> B)
{
	Real Ky;
...
void SSF_PENCIL::Add_Yderiv(Array<Complex,3> A, Array<Complex,3> B)
{
	Real Ky;
...
void SSF_PENCIL::Zderiv(Array<Complex,3> A, Array<Complex,3> B)
{
	Real Kz;
...
void SSF_PENCIL::Add_Zderiv(Array<Complex,3> A, Array<Complex,3> B)
{
	Real Kz;
...
void SSF_PENCIL::Laplacian(Real factor, Array<Complex,3> A, Array<Complex,3> B)
{
	Real Kxsqr;    // Kx^2
	Real Kxysqr;
	Real Ksqr;
...
void SSF_PENCIL::Subtract_Laplacian(Real factor, Array<Complex,3> A, Array<Complex,3> B)
{
	Real Kxsqr;    // Kx^2
	Real Kxysqr;
	Real Ksqr;
