 ...
 */
inline int SSF_SLAB::Get_kx(int lx) { return  (local_Nx_start + lx); }
 ...
 */
inline int SSF_SLAB::Get_lx(int kx)  { return  (kx-local_Nx_start); } 

inline int SSF_SLAB::Get_ix(int kx) {return  kx;}
 ...
 * \return kx corresponding to lx
 */
inline int SSF_SLAB::Get_ky(int ly) { return ly; }
 ...
 */
inline int SSF_SLAB::Get_ly(int ky) { return  ky; }

inline int SSF_SLAB::Get_iy(int ky) { return  ky; } //This is not implemented for this basis

inline int SSF_SLAB::Get_kz(int lz)  { return lz; } 

inline int SSF_SLAB::Get_lz(int kz)  { return kz; }

	// array index
inline int SSF_SLAB::Get_iz(int kz)  { return kz; }

inline bool SSF_SLAB::Probe_in_me(int kx, int ky, int kz) 
{
	int lx = Get_lx(kx);
...
inline void SSF_SLAB::Add_local_spectral_field(int lx, int ly, int lz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az, TinyVector<DP,3> V)
{
	...
	//REAL-SPACE
inline int SSF_SLAB::Get_lx_real_space(int rx)  {return  rx;}	

inline int SSF_SLAB::Get_ly_real_space(int ry)  {return ry-local_Ny_start;}	

inline int SSF_SLAB::Get_lz_real_space(int rz)  {return rz;}

inline int SSF_SLAB::Get_rx_real_space(int lx)  {return lx;}

inline int SSF_SLAB::Get_ry_real_space(int ly)  {return (ly+local_Ny_start);} 

inline int SSF_SLAB::Get_rz_real_space(int lz)  {return lz;}

inline bool SSF_SLAB::Probe_in_me_real_space(int rx, int ry, int rz) 
{
...
inline int SSF_SLAB::Min_radius_outside() 
{
	if	(global.field.waveno_switch)
