...
Real FFF_SLAB::Get_local_energy_real_space(Array<Real,3> Ar)
{	
...
Real FFF_SLAB::Get_local_energy(Array<Complex,3> A)
{
...
Real FFF_SLAB::Get_local_energy_real_space(Array<Real,3> Ar, Array<Real,3> Br)
{
...
Real FFF_SLAB::Get_local_energy(Array<Complex,3> A, Array<Complex,3> B)
{	
...
void FFF_SLAB::Compute_local_helicity
(
...
void FFF_SLAB::Compute_total_helicity
(
 Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az,
...
void FFF_SLAB::Compute_local_shell_spectrum_helicity
(
	Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, 
...
void FFF_SLAB::Compute_shell_spectrum_helicity
(
	Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az, 
...
// Not for 2D
void FFF_SLAB::Compute_local_ring_spectrum_helicity
(
 Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az,
...
void FFF_SLAB::Compute_ring_spectrum_helicity
(
 Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az,
...
void FFF_SLAB::Compute_local_cylindrical_ring_spectrum_helicity
(
 Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az,
...
//
//
void FFF_SLAB::Compute_cylindrical_ring_spectrum_helicity
(
 Array<Complex,3> Ax, Array<Complex,3> Ay, Array<Complex,3> Az,
