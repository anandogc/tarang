...
DP FFF_SLAB::Get_local_energy_real_space(Array<DP,3> Ar)
{	
...
DP FFF_SLAB::Get_local_energy(Array<complx,3> A)
{
...
DP FFF_SLAB::Get_local_energy_real_space(Array<DP,3> Ar, Array<DP,3> Br)
{
...
DP FFF_SLAB::Get_local_energy(Array<complx,3> A, Array<complx,3> B)
{	
	DP total = mydot(A, B);
