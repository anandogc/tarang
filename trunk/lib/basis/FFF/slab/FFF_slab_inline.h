...
inline complx FFF_SLAB::Get_spectral_field(int kx, int ky, int kz, Array<complx,3> A)
{ 
	int lx = Get_lx(kx);
    int ly = Get_ly(ky);
...
inline TinyVector<complx,3>  FFF_SLAB::Get_spectral_field(int kx, int ky, int kz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az)
{
...
/*
inline DP FFF_SLAB::Get_spectral_field(int kx, int ky, int kz, Array<complx,3> A)
{ 
	cout << "MYERROR: FFF_SLAB::Get_spectral_field(); Use complex data type " << endl; 
}

inline TinyVector<DP,3> FFF_SLAB::Get_spectral_field(int kx, int ky, int kz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az)
{
...
inline void FFF_SLAB::Assign_spectral_field(int kx, int ky, int kz, Array<complx,3> A, complx field)
{ 
	int lx = Get_lx(kx);
    int ly = Get_ly(ky);
...
inline void FFF_SLAB::Assign_spectral_field(int kx, int ky, int kz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az, TinyVector<complx,3> V)
{
	int lx = Get_lx(kx);
    int ly = Get_ly(ky);
...
inline void FFF_SLAB::Assign_spectral_field(int kx, int ky, int kz, Array<complx,3> A,DP field)
{ 
	cout << "MYERROR: FFF_SLAB::Assign_spectral_field(); Use complex data type " << endl; 
}

inline void FFF_SLAB::Assign_spectral_field(int kx, int ky, int kz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az, TinyVector<DP,3> V)
{
...
inline void FFF_SLAB::Add_spectral_field(int kx, int ky, int kz, Array<complx,3> A, complx field)
{ 
	int lx = Get_lx(kx);
    int ly = Get_ly(ky);
...
inline void FFF_SLAB::Add_spectral_field(int kx, int ky, int kz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az, TinyVector<complx,3> V)
{
	int lx = Get_lx(kx);
    int ly = Get_ly(ky);
...
inline void FFF_SLAB::Add_spectral_field(int kx, int ky, int kz, Array<complx,3> A,DP field)
{ 
	cout << "MYERROR: FFF_SLAB::Assign_spectral_field(); Use complex data type " << endl; 
}

inline void FFF_SLAB::Add_spectral_field(int kx, int ky, int kz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az, TinyVector<DP,3> V)
{
...
inline complx FFF_SLAB::Get_local_spectral_field(int lx, int ly, int lz, Array<complx,3> A)
{ 
	return A(lx, ly, lz);
}

inline TinyVector<complx,3> FFF_SLAB::Get_local_spectral_field(int lx, int ly, int lz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az)
{
...
inline DP FFF_SLAB::Get_local_spectral_field(int lx, int ly, int lz, Array<complx,3> A)
{ 
	cerr << "MYERROR: FFF_SLAB::Get_local_spectral_field(); Use complex data type " << endl; 
}

inline  TinyVector<DP,3> FFF_SLAB::Get_local_spectral_field(int lx, int ly, int lz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az)
{
...
inline void FFF_SLAB::Assign_local_spectral_field(int lx, int ly, int lz, Array<complx,3> A, complx field)
{ 	
	if ((ly >= 0) && (ly < local_Ny))
		A(lx, ly, lz) = field;
}
...
inline void FFF_SLAB::Assign_local_spectral_field(int lx, int ly, int lz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az, TinyVector<complx,3> V)
{	
...
inline void FFF_SLAB::Assign_local_spectral_field(int lx, int ly, int lz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az, TinyVector<DP,3> V)
{
	
	cout << "MYERROR: FFF_SLAB::Assign_spectral_field(); Use complex data type " << endl;
}

inline void FFF_SLAB::Assign_local_spectral_field(int lx, int ly, int lz, Array<complx,3> A, DP field)
{ 
	cout << "MYERROR: FFF_SLAB::Assign_spectral_field(); Use complex data type " << endl; 
}

inline void FFF_SLAB::Add_local_spectral_field(int lx, int ly, int lz, Array<complx,3> A, complx field)
{ 	
	if ((ly >= 0) && (ly < local_Ny))
		A(lx, ly, lz) += field;
}

inline void FFF_SLAB::Add_local_spectral_field(int lx, int ly, int lz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az, TinyVector<complx,3> V)
{	
...
inline void FFF_SLAB::Add_local_spectral_field(int lx, int ly, int lz, Array<complx,3> A, DP field)
{ 
	cout << "MYERROR: FFF_SLAB::Assign_spectral_field(); Use complex data type " << endl; 
}

inline void FFF_SLAB::Add_local_spectral_field(int lx, int ly, int lz, Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az, TinyVector<DP,3> V)
{
...
inline DP FFF_SLAB::Get_real_field(int rx, int ry, int rz, Array<DP,3> A)
{	
...
inline TinyVector<DP,3> FFF_SLAB::Get_real_field(int rx, int ry, int rz, Array<DP,3> Ax, Array<DP,3> Ay, Array<DP,3> Az)
{
	int lx = Get_lx_real_space(rx);
    int ly = Get_ly_real_space(ry);
    int lz = Get_lz_real_space(rz);
...
inline void FFF_SLAB::Assign_real_field(int rx, int ry, int rz, Array<DP,3> A, DP field)
{	
	int lx = Get_lx_real_space(rx);
    int ly = Get_ly_real_space(ry);
    int lz = Get_lz_real_space(rz);
...
inline void FFF_SLAB::Assign_real_field(int rx, int ry, int rz, Array<DP,3> Ax, Array<DP,3> Ay, Array<DP,3> Az, TinyVector<DP,3> V)
{
	int lx = Get_lx_real_space(rx);
    int ly = Get_ly_real_space(ry);
    int lz = Get_lz_real_space(rz);
...
// Real K
inline void FFF_SLAB::Wavenumber(int lx, int ly, int lz, TinyVector<DP,3> & K)
{
...
// Omega = cross(V,K).
inline void FFF_SLAB::Wavenumber(int lx, int ly, int lz, TinyVector<complx,3> & K)
{
...
inline DP FFF_SLAB::Kmagnitude(int lx, int ly, int lz)
{
 ...
 */
inline DP FFF_SLAB::Approx_number_modes_in_shell(int radius)
{
	DP ans = 0.0;
...
inline DP FFF_SLAB::Multiplicity_factor(int lx, int ly, int lz)
{
	DP factor;
...
inline DP FFF_SLAB::Modal_energy(int lx, int ly, int lz, Array<complx,3> A)
{
...
inline DP FFF_SLAB::Get_Modal_helicity
(
...
inline DP FFF_SLAB::AnisKpll(int lx, int ly, int lz)
{	
...
inline DP FFF_SLAB::AnisKperp(int lx, int ly, int lz)
{
	if (global.field.anisotropy_dirn == 1)
...
inline DP FFF_SLAB::AnisKh1(int lx, int ly, int lz)
{	
	if (global.field.anisotropy_dirn == 1)
		return (Get_ky(ly) * kfactor[2]);  
...
inline DP FFF_SLAB::AnisKh2(int lx, int ly, int lz)
{	
	if (global.field.anisotropy_dirn == 1)
		return (lz * kfactor[3]);  
...
inline DP FFF_SLAB::Anis_min_Kpll() 
{ 
	return 0.0;
}
				
/// Cylindrical: Anis_max_Kpll
inline DP FFF_SLAB::Anis_max_Kpll() 
{ 
	DP maxKpll = 0;
...
// Max polar angle
inline DP FFF_SLAB::Get_max_polar_angle() 
{ 
 ...
 */	
inline DP FFF_SLAB::AnisKvect_polar_angle(int lx, int ly, int lz)
{
	DP kkpll, kkperp;
 ...
 * \return \f$ \pi/2 \f$ if \f$ K_{||} = 0 \f$.
 */	
inline DP FFF_SLAB::AnisKvect_azimuthal_angle(int lx, int ly, int lz)
{
