...
SSS_PENCIL::SSS_PENCIL()
{
	...
	spectralTransform.Init("SSS", Nx, Ny, Nz, global.mpi.num_p_cols);
	
	global.field.shape_complex_array = spectralTransform.local_Nx_row, spectralTransform.local_Ny_col, Nz/2;
