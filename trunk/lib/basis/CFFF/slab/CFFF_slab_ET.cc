...
DP CFFF_SLAB::Local_shell_mult_single
( 
...
//
//
DP CFFF_SLAB::Shell_mult_single
( 
	Array<complx,3> A, Array<complx,3> B, 
	DP inner_radius, DP outer_radius
)
...
void CFFF_SLAB::Local_shell_mult_all
( 
	Array<complx,3> A, Array<complx,3> B, 
...
void CFFF_SLAB::Local_ring_mult_all
( 
	Array<complx,3> A, Array<complx,3> B, 
...
void CFFF_SLAB::Local_cyl_ring_mult_all
(
	Array<complx,3> A, Array<complx,3> B, 
	Array<DP,2> local_result
)
...
void CFFF_SLAB::Cyl_ring_mult_all
(
	Array<complx,3> A, Array<complx,3> B, 
	Array<DP,2> result
)
...
void CFFF_SLAB::Local_shell_mult_all_imagVW_B0
(
	TinyVector<DP,3> B0,
	Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
	Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz, 
...
void CFFF_SLAB::Shell_mult_all_imagVW_B0
( 
	TinyVector<DP,3> B0,
	Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
	Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz,  
...
void CFFF_SLAB::Local_ring_mult_all_imagVW_B0
(
	TinyVector<DP,3> B0,
	Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
	Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz, 
...
void CFFF_SLAB::Ring_mult_all_imagVW_B0
(
	TinyVector<DP,3> B0,
	Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
	Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz,  
...
void CFFF_SLAB::Local_cyl_ring_mult_all_imagVW_B0
( 
	TinyVector<DP,3> B0,
	Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
	Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz, 
...
void CFFF_SLAB::Cyl_ring_mult_all_imagVW_B0
(
	TinyVector<DP,3> B0,
	Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
	Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz, 
...
// 
DP CFFF_SLAB::Local_shell_mult_vorticity
(
    Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
    Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz,  
    DP inner_radius, DP outer_radius
...
DP CFFF_SLAB::Shell_mult_vorticity
(
    Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
    Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz,  
    DP inner_radius, DP outer_radius
...
//
DP CFFF_SLAB::Local_shell_mult_vector_potential
(
    Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
    Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz,  
    DP inner_radius, DP outer_radius
...
//
//
DP CFFF_SLAB::Shell_mult_vector_potential
( 
    Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
    Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz,  
    DP inner_radius, DP outer_radius
...
//
void CFFF_SLAB::Local_shell_mult_vorticity_all
( 
    Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
    Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz,
    Array<DP,1> result
...
//
//
void CFFF_SLAB::Shell_mult_vorticity_all
(
    Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
    Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz,
    Array<DP,1> result
...
//
void CFFF_SLAB::Local_shell_mult_vector_potential_all
(
     Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
     Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz,  
     Array<DP,1> result
...
//
//
void CFFF_SLAB::Shell_mult_vector_potential_all
(
    Array<complx,3> Ax, Array<complx,3> Ay, Array<complx,3> Az,
    Array<complx,3> Bx, Array<complx,3> By, Array<complx,3> Bz,
    Array<DP,1> result
...
void CFFF_SLAB::Fill_array_shell(Array<complx,3> A, Array<complx,3> B, DP inner_radius, DP outer_radius)					
{	
/*	DP Kmag;
...
void CFFF_SLAB::Fill_array_ring(Array<complx,3> A, Array<complx,3> B, DP inner_radius, DP outer_radius, DP left_angle, DP right_angle)		
{	
/*	DP Kmag, theta;
...
void CFFF_SLAB::Fill_array_cylindrical_ring(Array<complx,3> A, Array<complx,3> B, DP inner_radius, DP outer_radius, DP h_lower, DP h_upper)		
{	
/*	DP Kmag, Kpll;
