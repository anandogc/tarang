...
int IMHDastro_main()
{
	...
	global.field.diss_coefficients[3] = 1.0/global.PHYSICS.Peclet_c;
	...
	global.PHYSICS.Prandtl_c = global.PHYSICS.Peclet_c/global.PHYSICS.Reynolds;
    ...
    if (global.program.iter_or_diag == "ITERATION") {
		...
		FluidSF C(global.field.diss_coefficients[3], global.field.hyper_diss_coefficients[3], global.field.hyper_diss_exponents[3], global.force.C_switch, "C");
        ...
        fluidIO_incompress.Read_init_cond(U, B, T, C);
        ...
        fluidIO_incompress.Output_all_inloop(U, B, T, C, P);  // for initial cond
        ...
        do 	{
            ...
            time_advance_incompress.Time_advance_step(U, B, T, C, P, Force);
         ...
         /*    if (global.program.kind == "KEPLERIAN")  {
            ...
            fluidIO_incompress.Output_all_inloop(U, B, T, C, P);
        ...
        fluidIO_incompress.Output_last(U, B, T, C, P);
